    ...
    <div class="row g-0">
        <div class="col-md-3 d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="min-height: 100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-1">
                <li><a href="/dashboard" class="nav-link text-white"><i class="bi bi-bank me-2"></i>HOME</a></li>
                <li><a href="/project" class="nav-link text-white"><i class="bi bi-pc-display-horizontal me-2"></i>MASTER PROJECT</a></li>
                <li><a href="/service" class="nav-link active text-white"><i class="bi bi-hammer me-2"></i>MASTER SERVICE</a></li>
            </ul>
            <hr>
            <div class="dropdown">
