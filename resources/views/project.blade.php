        ...
        <div class="col-md-3 d-flex flex-column flex-shrink-0 p-3 text-white bg-dark " style="height: inherit; min-height:100vh;">
            <a class="d-flex  alignment-items-center text-white text-decoration-none mb-1" href="#">
                ...
                <ul class="nav nav-pills flex-column mb-auto mt-1">
                    <li>
                        <a href="/Mdashboard" class="nav-link text-white"><i class="bi bi-bank me-2"></i>HOME</a>
                    </li>
                    <li>
                        <a href="/Mproject" class="nav-link active text-white"><i class="bi bi-pc-display-horizontal me-2"></i>MASTER PROJECT</a>
                    </li>
                    <li>
                        <a href="/Mservice" class="nav-link text-white"><i class="bi bi-hammer me-2"></i>MASTER SERVICE</a>
                    </li>
                </ul>
                <hr>
                <div class="dropdown">
            ...
            <div class="col-md-9">
              <div class="container-fluid">
                  <div class="row">
                      <h2 class="mt-2">@yield('content-title')</h2>
                  </div>
                  <div class="row">
                      @yield('content')
                  </div>
